...
import 'package:project01/constants/item_classes.dart';

Color mPrimaryColor = const Color(0xff69a03a);
Color mSecondaryColor = const Color.fromRGBO(146, 146, 146, 1);
Color mBackgroundColor = Colors.white;
Color favoriteoutline = const Color.fromRGBO(237, 203, 21, 1);
Color favoriteselected = Colors.red;
