...
import 'package:fruitmarket2/login/page_4.dart';
  ...
  Widget build(BuildContext context) {
    ...
    body: Column
      ...
      children: [
        ...
        const Text("Enter the 4 digit code that was sent \n to your mobile number",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
        Padding(
