          ...
          children: [
                ...
                children: [
                  Center(child: Column(
                    ...
                    children: [
                      ...
                      const Text("El Wad Sayed",style: TextStyle(
                        color: Colors.white,
                        fontSize: 23,
                        fontWeight: FontWeight.bold,
                      ),),
                      const SizedBox(height: 7,),
                      const Text("Sayed_YA_Sayed@example.com",style: TextStyle(
                        color: Colors.white,
                        fontSize: 15,
                        fontWeight: FontWeight.bold,
                      ),),
                  ...
                  const Positioned(
                    top: 80,
                    right: 20,
                    child: Icon(Icons.note_alt, color: Colors.white,size: 35,),
                  )
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: const [
                  Icon(Icons.settings, color: Color(0xff69a03a),size: 35,),
                  SizedBox(width: 5,),
            ...
            Padding(
              ...
              child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: const [
                  Icon(Icons.star_rate, color: Color(0xff69a03a),size: 35,),
                  SizedBox(width: 5,),
            ...
            Padding(
              ...
              child: Row(
                ...
                crossAxisAlignment: CrossAxisAlignment.center,
                children: const [
                  Icon(Icons.share, color: Color(0xff69a03a),size: 35,),
                  SizedBox(width: 5,),
                  Text("Share a Friend",style: TextStyle(
                    color: Color(0xff69a03a),
                    fontSize: 18,
                  ),),
                ],
            ...
            InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: const [
                    Icon(Icons.logout, color: Color(0xff69a03a),size: 35,),
                    SizedBox(width: 5,),
